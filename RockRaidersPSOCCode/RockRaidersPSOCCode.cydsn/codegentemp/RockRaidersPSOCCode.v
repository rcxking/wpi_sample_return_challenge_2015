// ======================================================================
// RockRaidersPSOCCode.v generated from TopDesign.cysch
// 06/10/2015 at 13:59
...
module SCB_P4_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("3d65d08f-24d9-4db2-b139-535d9d297be0/81fcee8a-3b8b-4be1-9a5f-a5e2e619a938"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d65d08f-24d9-4db2-b139-535d9d297be0/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d65d08f-24d9-4db2-b139-535d9d297be0/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    SCB_P4_v2_0_0 PCComms (
        .interrupt(Net_115),
        .clock(1'b0));

	wire [0:0] tmpOE__Limit_LT_net;
	wire [0:0] tmpFB_0__Limit_LT_net;
	wire [0:0] tmpIO_0__Limit_LT_net;
	wire [0:0] tmpINTERRUPT_0__Limit_LT_net;
	electrical [0:0] tmpSIOVREF__Limit_LT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Limit_LT
		 (.oe(tmpOE__Limit_LT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Limit_LT_net[0:0]}),
		  .io({tmpIO_0__Limit_LT_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit_LT_net),
		  .interrupt({tmpINTERRUPT_0__Limit_LT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Limit_LT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorControl2EN_net;
	wire [0:0] tmpFB_0__MotorControl2EN_net;
	wire [0:0] tmpIO_0__MotorControl2EN_net;
	wire [0:0] tmpINTERRUPT_0__MotorControl2EN_net;
	electrical [0:0] tmpSIOVREF__MotorControl2EN_net;

	cy_psoc3_pins_v1_10
		#(.id("def4ce9b-9c7e-47a8-b1da-06ca3efcc2a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorControl2EN
		 (.oe(tmpOE__MotorControl2EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorControl2EN_net[0:0]}),
		  .io({tmpIO_0__MotorControl2EN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorControl2EN_net),
		  .interrupt({tmpINTERRUPT_0__MotorControl2EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorControl2EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorControl4EN_net;
	wire [0:0] tmpFB_0__MotorControl4EN_net;
	wire [0:0] tmpIO_0__MotorControl4EN_net;
	wire [0:0] tmpINTERRUPT_0__MotorControl4EN_net;
	electrical [0:0] tmpSIOVREF__MotorControl4EN_net;

	cy_psoc3_pins_v1_10
		#(.id("7e2eae02-207c-4414-a8c5-51117923a8e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorControl4EN
		 (.oe(tmpOE__MotorControl4EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorControl4EN_net[0:0]}),
		  .io({tmpIO_0__MotorControl4EN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorControl4EN_net),
		  .interrupt({tmpINTERRUPT_0__MotorControl4EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorControl4EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorControl3EN_net;
	wire [0:0] tmpFB_0__MotorControl3EN_net;
	wire [0:0] tmpIO_0__MotorControl3EN_net;
	wire [0:0] tmpINTERRUPT_0__MotorControl3EN_net;
	electrical [0:0] tmpSIOVREF__MotorControl3EN_net;

	cy_psoc3_pins_v1_10
		#(.id("6579af75-2b2d-4e01-8fe5-ca74150158d5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorControl3EN
		 (.oe(tmpOE__MotorControl3EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorControl3EN_net[0:0]}),
		  .io({tmpIO_0__MotorControl3EN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorControl3EN_net),
		  .interrupt({tmpINTERRUPT_0__MotorControl3EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorControl3EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v2_0_1 MotorComms (
        .interrupt(Net_1893),
        .clock(1'b0));

	wire [0:0] tmpOE__MotorControl1EN_net;
	wire [0:0] tmpFB_0__MotorControl1EN_net;
	wire [0:0] tmpIO_0__MotorControl1EN_net;
	wire [0:0] tmpINTERRUPT_0__MotorControl1EN_net;
	electrical [0:0] tmpSIOVREF__MotorControl1EN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		MotorControl1EN
		 (.oe(tmpOE__MotorControl1EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorControl1EN_net[0:0]}),
		  .io({tmpIO_0__MotorControl1EN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorControl1EN_net),
		  .interrupt({tmpINTERRUPT_0__MotorControl1EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorControl1EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorControl5EN_net;
	wire [0:0] tmpFB_0__MotorControl5EN_net;
	wire [0:0] tmpIO_0__MotorControl5EN_net;
	wire [0:0] tmpINTERRUPT_0__MotorControl5EN_net;
	electrical [0:0] tmpSIOVREF__MotorControl5EN_net;

	cy_psoc3_pins_v1_10
		#(.id("b7873e30-8197-4b65-b9dd-eef416535b5f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorControl5EN
		 (.oe(tmpOE__MotorControl5EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorControl5EN_net[0:0]}),
		  .io({tmpIO_0__MotorControl5EN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorControl5EN_net),
		  .interrupt({tmpINTERRUPT_0__MotorControl5EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorControl5EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__FPGA_EN_net;
	wire [0:0] tmpFB_0__FPGA_EN_net;
	wire [0:0] tmpIO_0__FPGA_EN_net;
	wire [0:0] tmpINTERRUPT_0__FPGA_EN_net;
	electrical [0:0] tmpSIOVREF__FPGA_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("ef49710c-8d5b-4dde-8c3a-6e8afe455097"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		FPGA_EN
		 (.oe(tmpOE__FPGA_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FPGA_EN_net[0:0]}),
		  .io({tmpIO_0__FPGA_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__FPGA_EN_net),
		  .interrupt({tmpINTERRUPT_0__FPGA_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FPGA_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7a61b723-806d-4996-8259-c3024ebc8c46"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("782ac506-9583-4da1-b159-daad784e65b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("43e1dc00-9e8d-4fa4-8641-f1c6d5c64a5b"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__OpenPressure_net;
	wire [0:0] tmpFB_0__OpenPressure_net;
	wire [0:0] tmpIO_0__OpenPressure_net;
	wire [0:0] tmpINTERRUPT_0__OpenPressure_net;
	electrical [0:0] tmpSIOVREF__OpenPressure_net;

	cy_psoc3_pins_v1_10
		#(.id("85432dbb-bede-4548-a560-b9179fdc451b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OpenPressure
		 (.oe(tmpOE__OpenPressure_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpenPressure_net[0:0]}),
		  .io({tmpIO_0__OpenPressure_net[0:0]}),
		  .siovref(tmpSIOVREF__OpenPressure_net),
		  .interrupt({tmpINTERRUPT_0__OpenPressure_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OpenPressure_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OpenExhaust_net;
	wire [0:0] tmpFB_0__OpenExhaust_net;
	wire [0:0] tmpIO_0__OpenExhaust_net;
	wire [0:0] tmpINTERRUPT_0__OpenExhaust_net;
	electrical [0:0] tmpSIOVREF__OpenExhaust_net;

	cy_psoc3_pins_v1_10
		#(.id("db9cbf6c-4f19-42be-956f-4935764f530b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OpenExhaust
		 (.oe(tmpOE__OpenExhaust_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpenExhaust_net[0:0]}),
		  .io({tmpIO_0__OpenExhaust_net[0:0]}),
		  .siovref(tmpSIOVREF__OpenExhaust_net),
		  .interrupt({tmpINTERRUPT_0__OpenExhaust_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OpenExhaust_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ClosePressure_net;
	wire [0:0] tmpFB_0__ClosePressure_net;
	wire [0:0] tmpIO_0__ClosePressure_net;
	wire [0:0] tmpINTERRUPT_0__ClosePressure_net;
	electrical [0:0] tmpSIOVREF__ClosePressure_net;

	cy_psoc3_pins_v1_10
		#(.id("0b0ebb5e-ca1e-4a83-80d1-6f1cf9bc23b6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ClosePressure
		 (.oe(tmpOE__ClosePressure_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ClosePressure_net[0:0]}),
		  .io({tmpIO_0__ClosePressure_net[0:0]}),
		  .siovref(tmpSIOVREF__ClosePressure_net),
		  .interrupt({tmpINTERRUPT_0__ClosePressure_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ClosePressure_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CloseExhaust_net;
	wire [0:0] tmpFB_0__CloseExhaust_net;
	wire [0:0] tmpIO_0__CloseExhaust_net;
	wire [0:0] tmpINTERRUPT_0__CloseExhaust_net;
	electrical [0:0] tmpSIOVREF__CloseExhaust_net;

	cy_psoc3_pins_v1_10
		#(.id("933f568a-1212-4531-8a4d-3b457858f55b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CloseExhaust
		 (.oe(tmpOE__CloseExhaust_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CloseExhaust_net[0:0]}),
		  .io({tmpIO_0__CloseExhaust_net[0:0]}),
		  .siovref(tmpSIOVREF__CloseExhaust_net),
		  .interrupt({tmpINTERRUPT_0__CloseExhaust_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CloseExhaust_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Limit_LS_net;
	wire [0:0] tmpFB_0__Limit_LS_net;
	wire [0:0] tmpIO_0__Limit_LS_net;
	wire [0:0] tmpINTERRUPT_0__Limit_LS_net;
	electrical [0:0] tmpSIOVREF__Limit_LS_net;

	cy_psoc3_pins_v1_10
		#(.id("38af3715-9340-4f8c-8fde-81b138189725"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Limit_LS
		 (.oe(tmpOE__Limit_LS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Limit_LS_net[0:0]}),
		  .io({tmpIO_0__Limit_LS_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit_LS_net),
		  .interrupt({tmpINTERRUPT_0__Limit_LS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Limit_LS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Limit_RT_net;
	wire [0:0] tmpFB_0__Limit_RT_net;
	wire [0:0] tmpIO_0__Limit_RT_net;
	wire [0:0] tmpINTERRUPT_0__Limit_RT_net;
	electrical [0:0] tmpSIOVREF__Limit_RT_net;

	cy_psoc3_pins_v1_10
		#(.id("619c2385-f30a-44ee-a77a-4b107cc65c63"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Limit_RT
		 (.oe(tmpOE__Limit_RT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Limit_RT_net[0:0]}),
		  .io({tmpIO_0__Limit_RT_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit_RT_net),
		  .interrupt({tmpINTERRUPT_0__Limit_RT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Limit_RT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Limit_RS_net;
	wire [0:0] tmpFB_0__Limit_RS_net;
	wire [0:0] tmpIO_0__Limit_RS_net;
	wire [0:0] tmpINTERRUPT_0__Limit_RS_net;
	electrical [0:0] tmpSIOVREF__Limit_RS_net;

	cy_psoc3_pins_v1_10
		#(.id("49746033-5ad3-4a4e-80a4-2c44ff91624b"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Limit_RS
		 (.oe(tmpOE__Limit_RS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Limit_RS_net[0:0]}),
		  .io({tmpIO_0__Limit_RS_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit_RS_net),
		  .interrupt({tmpINTERRUPT_0__Limit_RS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Limit_RS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Steering_Register (
        .control_1(Net_2242),
        .control_2(Net_2243),
        .control_3(Net_2244),
        .control_0(Net_2245),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Steering_Register.Bit0Mode = 0;
    defparam Steering_Register.Bit1Mode = 0;
    defparam Steering_Register.Bit2Mode = 0;
    defparam Steering_Register.Bit3Mode = 0;
    defparam Steering_Register.Bit4Mode = 0;
    defparam Steering_Register.Bit5Mode = 0;
    defparam Steering_Register.Bit6Mode = 0;
    defparam Steering_Register.Bit7Mode = 0;
    defparam Steering_Register.BitValue = 0;
    defparam Steering_Register.BusDisplay = 0;
    defparam Steering_Register.ExtrReset = 0;
    defparam Steering_Register.NumOutputs = 1;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_2100)
    begin
        cy_tff_1 <= Net_2096^Net_1901;
    end
    assign Net_1901 = cy_tff_1;
    // -- TFF End --

    assign Net_2096 = 1'h1;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_1901 or Net_2145 or Net_2170)
        begin
            case (Net_2170)
                1'b0 :  tmp__mux_1_reg = Net_1901;
                1'b1 :  tmp__mux_1_reg = Net_2145;
            endcase
        end
        assign Net_2214 = tmp__mux_1_reg;
    end
    // -- Mux end --

    assign Net_2145 = 1'h1;

    CyControlReg_v1_80 Pause_Register (
        .control_1(Net_2190),
        .control_2(Net_2191),
        .control_3(Net_2192),
        .control_0(Net_2170),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Pause_Register.Bit0Mode = 0;
    defparam Pause_Register.Bit1Mode = 0;
    defparam Pause_Register.Bit2Mode = 0;
    defparam Pause_Register.Bit3Mode = 0;
    defparam Pause_Register.Bit4Mode = 0;
    defparam Pause_Register.Bit5Mode = 0;
    defparam Pause_Register.Bit6Mode = 0;
    defparam Pause_Register.Bit7Mode = 0;
    defparam Pause_Register.BitValue = 1;
    defparam Pause_Register.BusDisplay = 0;
    defparam Pause_Register.ExtrReset = 0;
    defparam Pause_Register.NumOutputs = 1;
