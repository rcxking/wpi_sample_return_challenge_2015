...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/bryant/wpi_sample_return_challenge_2015/test_indigo_workspace/src/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/bryant/wpi_sample_return_challenge_2015/test_indigo_workspace/devel)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/bryant/wpi_sample_return_challenge_2015/test_indigo_workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bryant <bryant@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bryant/wpi_sample_return_challenge_2015/test_indigo_workspace/src/opencv_tests/${idir}'.  Ask the maintainer 'bryant <bryant@todo.todo>' to fix it.")
    endif()
