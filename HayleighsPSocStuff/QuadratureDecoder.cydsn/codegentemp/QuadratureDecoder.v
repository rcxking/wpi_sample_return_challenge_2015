// ======================================================================
// QuadratureDecoder.v generated from TopDesign.cysch
// 05/29/2015 at 20:27
...
module top ;
    ...
    assign Net_125 = ~Net_112;

    // -- DFF Start --
    reg  cydff_3;
    always @(posedge Net_228)
    begin
        cydff_3 <= Net_183;
    end
    ...
    assign Net_184 = Net_182 & Net_117;


    assign Net_180 = Net_115 & Net_112;


    assign Net_186 = Net_183 & Net_125;
	...
	cy_psoc3_pins_v1_10
		#(.id("03f87fd7-cd20-4247-987d-85d593645244"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
